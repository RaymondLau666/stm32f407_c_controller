...
typedef struct {
    ...
    uint16_t gripper_power_limit;
    uint8_t mains_power_gimbal_output : 1;
    uint8_t mains_power_gripper_output : 1;
    uint8_t mains_power_shooter_output : 1;
} ext_game_robot_state_t;
// 0x0202
typedef struct {
    uint16_t gripper_volt;
    uint16_t gripper_current;
    float gripper_power;
    uint16_t gripper_power_buffer;
